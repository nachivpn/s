...
module PFC.Term.Properties where
...
module AdhocLemmas where
  ...
  --
  red-dia1-crunch-lemma : (w : Γ ⊆ Γ') (t : Tm Γ (◇ a)) (u : Tm (Γ `, a) b) (u' : Tm (Γ `, b) c)
    → substTm (wkSub freshWk idₛ `, wkTm (keep w) u) (wkTm (keep w) u') ≡ wkTm (keep w) (substTm (wkSub freshWk idₛ `, u) u')
  red-dia1-crunch-lemma w t u u' = let open ≡-Reasoning in begin
  ...
  --
  red-dia2-crunch-lemma : (w : Γ ⊆ Θ) (s : Sub Γ Δ) (t : Tm Θ a)
    → wkSub freshWk s ∙ₛ (embWk w `, t) ≡ wkSub w s
  red-dia2-crunch-lemma w s t = let open ≡-Reasoning in begin
